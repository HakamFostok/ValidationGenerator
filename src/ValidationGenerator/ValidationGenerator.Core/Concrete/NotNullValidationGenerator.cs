...
namespace ValidationGenerator.Core.Concrete
{
    ...
    {
        private const string NotNullAttribute = "ValidationGenerator.Shared.NotNullAttribute";
        private const string ValidationGeneratorAttribute = "ValidationGenerator.Shared.ValidationGeneratorAttribute";
