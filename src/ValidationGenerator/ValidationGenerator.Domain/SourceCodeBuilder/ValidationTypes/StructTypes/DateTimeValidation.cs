...
internal static class DateTimeValidation
{
    ...
    internal static (string condition, string defaultErrorMessage) GetNotDefault(string propertyName, bool isNullable)
    {
    ...
    internal static (string condition, string defaultErrorMessage) GetPastDateTime(string propertyName, bool isNullable)
    {
    ...
    internal static (string condition, string defaultErrorMessage) GetPastDateTimeUTC(string propertyName, bool isNullable)
    {
    ...
    internal static (string condition, string defaultErrorMessage) GetFutureDateTime(string propertyName, bool isNullable)
    {
        string condition = isNullable ? $"{propertyName}.HasValue && {propertyName}.Value <= DateTime.Now" : $"{propertyName} <= DateTime.Now";
    ...
    internal static (string condition, string defaultErrorMessage) GetFutureDateTimeUTC(string propertyName, bool isNullable)
    {
        string condition = isNullable ? $"{propertyName}.HasValue && {propertyName}.Value <= DateTime.UtcNow" : $"{propertyName} <= DateTime.UtcNow";
        string errorMessage = $"{propertyName} should be a future DateTime";
        return (condition, errorMessage);
